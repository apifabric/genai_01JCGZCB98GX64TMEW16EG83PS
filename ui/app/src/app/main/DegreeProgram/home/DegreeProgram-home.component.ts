...
@Component({
  selector: 'DegreeProgram-home',
  templateUrl: './DegreeProgram-home.component.html',
  styleUrls: ['./DegreeProgram-home.component.scss']
})
export class DegreeProgramHomeComponent implements AfterViewInit {
