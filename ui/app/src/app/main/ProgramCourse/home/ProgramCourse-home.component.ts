...
@Component({
  selector: 'ProgramCourse-home',
  templateUrl: './ProgramCourse-home.component.html',
  styleUrls: ['./ProgramCourse-home.component.scss']
})
export class ProgramCourseHomeComponent implements AfterViewInit {
