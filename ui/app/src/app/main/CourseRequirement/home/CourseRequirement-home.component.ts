...
@Component({
  selector: 'CourseRequirement-home',
  templateUrl: './CourseRequirement-home.component.html',
  styleUrls: ['./CourseRequirement-home.component.scss']
})
export class CourseRequirementHomeComponent implements AfterViewInit {
