...
@Component({
  selector: 'StudentActivity-home',
  templateUrl: './StudentActivity-home.component.html',
  styleUrls: ['./StudentActivity-home.component.scss']
})
export class StudentActivityHomeComponent implements AfterViewInit {
