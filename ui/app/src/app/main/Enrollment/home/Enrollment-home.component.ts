...
@Component({
  selector: 'Enrollment-home',
  templateUrl: './Enrollment-home.component.html',
  styleUrls: ['./Enrollment-home.component.scss']
})
export class EnrollmentHomeComponent implements AfterViewInit {
