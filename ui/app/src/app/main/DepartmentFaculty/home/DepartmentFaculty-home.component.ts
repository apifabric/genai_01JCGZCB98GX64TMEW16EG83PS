...
@Component({
  selector: 'DepartmentFaculty-home',
  templateUrl: './DepartmentFaculty-home.component.html',
  styleUrls: ['./DepartmentFaculty-home.component.scss']
})
export class DepartmentFacultyHomeComponent implements AfterViewInit {
