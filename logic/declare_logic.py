...
def declare_logic():
    ...
    # Ensure a student qualifies as an honor student based on service activity count.
    Rule.count(derive=Student.service_activity_count, as_count_of=StudentActivity, where=lambda row: row.activity.is_service)
