...
resourcename="schoolmgmt"  # lower case, only
resourcegroup="schoolmgmt_rg"
...
# git clone https://github.com/apilogicserver/schoolmgmt.git
# cd schoolmgmt
...
az group create --name schoolmgmt_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group schoolmgmt_rg --sku S1 --is-linux
az container create --resource-group schoolmgmt_rg --name schoolmgmt --image apilogicserver/schoolmgmt:latest --dns-name-label schoolmgmt --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//schoolmgmt.westus.azurecontainer.io:5656'
